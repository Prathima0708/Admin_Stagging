...
import { assetServiceBaseUrl, coreServiceBaseUrl } from "../../utils/backendUrls";
...
function Preview(props) {
  ...
  const onsubmit = async () => {
    ...
    if (!registrationNumber) errors.push("Store Registration Number not provided");
    ...
    if (id) {
      if (shopImageFormData.deletedImageUrl) {
        await axios
          .delete(`${assetServiceBaseUrl}/delete/by-url?url=${shopImageFormData.deletedImageUrl}`)
          .catch((err) => console.log(err));
      }
      if (customerRegistrationFormData.deletedImageUrl) {
        await axios
          .delete(`${assetServiceBaseUrl}/delete/by-url?url=${customerRegistrationFormData.deletedImageUrl}`)
          .catch((err) => console.log(err));
      }
      if (tradeLicenseNumberFormData.deletedImageUrl) {
        await axios
          .delete(`${assetServiceBaseUrl}/delete/by-url?url=${tradeLicenseNumberFormData.deletedImageUrl}`)
          .catch((err) => console.log(err));
      }
      ...
      if (contactPersonIdProofFormData.deletedImageUrl) {
        await axios
          .delete(`${assetServiceBaseUrl}/delete/by-url?url=${contactPersonIdProofFormData.deletedImageUrl}`)
          .catch((err) => console.log(err));
      }
      ...
      if (customerRegistrationFormData.formData) {
        const customerRegUrl = await uploaderUtil(customerRegistrationFormData.formData);
        payload.resources.push({
      ...
      if (tradeLicenseNumberFormData.formData) {
        const tradeLicenseUrl = await uploaderUtil(tradeLicenseNumberFormData.formData);
        payload.resources.push({
      ...
      if (authorizedPersonIdProofFormData.url) {
        payload.authorizedPersonIdentificationUrl = authorizedPersonIdProofFormData.url;
      }
      if (contactPersonIdProofFormData.formData) {
        payload.contactPersonIdentificationUrl = await uploaderUtil(contactPersonIdProofFormData.formData);
      }
      if (contactPersonIdProofFormData.url) {
        payload.contactPersonIdentificationUrl = contactPersonIdProofFormData.url;
      }
      ...
      <Grid container spacing={3}>
        ...
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input className="mt-1 border" disabled value={businessInfo.name ? businessInfo.name : null} />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              ...
              disabled
              value={businessInfo.registrationNumber ? businessInfo.registrationNumber : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            <span>Phone</span>
            <Input className="mt-1 border" disabled value={businessInfo.phone ? businessInfo.phone : null} />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            <span> Email</span>
            <Input className="mt-1 border" disabled value={businessInfo.email ? businessInfo.email : null} />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <MapWithAMarker
                    ...
                    gLatLng={{ lat: businessInfo.latitude, lng: businessInfo.longitude }}
                  />
          </Label>
        </Grid>
        ...
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={businessInfo.address.buildingName ? businessInfo.address.buildingName : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={businessInfo.address.street ? businessInfo.address.street : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={businessInfo.address.locality ? businessInfo.address.locality : null}
            />
          </Label>
        </Grid>
        <Grid item lg={3} md={6} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={businessInfo.address.city ? businessInfo.address.city : null}
            />
          </Label>
        </Grid>
        <Grid item lg={3} md={6} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={businessInfo.address.landmark ? businessInfo.address.landmark : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <img
              ...
              width="300"
              src={
                businessInfo.shopImageFormData?.url || businessInfo.shopImageFormData?.previewUrl || imageUrl
              }
              alt=""
            ></img>
          </Label>
            ...
            {workingHours.length > 0 ? (
              workingHours.map((day) => (
                <div className="flex flex-row justify-between">
                  ...
                  <div className="w-1/3 px-1">
                    <Input className="mt-1 border " disabled value={day.openTime} />
                  </div>
                  <div className="w-1/3 px-1">
                    <Input className="mt-1 border " disabled value={`${day.workingTimeInMins} Minutes`} />
                  </div>
                </div>
              ))
            ) : (
              <Input className="mt-1 border" disabled value="Working hours not specified" />
            )}
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input className="mt-1 border" disabled value={`${storeShowTimeCutOff} Days`} />
          </Label>
        </Grid>
        <Grid item md={12} className="">
        ...
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={contactInfo.authorizedPerson ? contactInfo.authorizedPerson : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className=""></Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={contactInfo.authorizedPersonPhone ? contactInfo.authorizedPersonPhone : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              ...
              type="mail"
              disabled
              value={contactInfo.authorizedPersonEmail ? contactInfo.authorizedPersonEmail : null}
            />
          </Label>
        </Grid>
        {/* <Grid item lg={6} md={12} sm={12} xs={12} className="">
        ...
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={contactInfo.contactPerson ? contactInfo.contactPerson : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className=""></Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={contactInfo.contactPersonPhone ? contactInfo.contactPersonPhone : null}
            />
          </Label>
        </Grid>
        <Grid item lg={6} md={12} sm={12} xs={12} className="">
          <Label>
            ...
            <Input
              className="mt-1 border"
              disabled
              value={contactInfo.contactPersonEmail ? contactInfo.contactPersonEmail : null}
            />
          </Label>
        </Grid>
        {/* <Grid item lg={6} md={12} sm={12} xs={12} className="">
