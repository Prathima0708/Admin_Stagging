...
function ContactInfo(props) {
  ...
  const [authorizedPersonIdProofFormData, setAuthorizedPersonIdProofFormData] = useState({
    url: undefined,
    formData: undefined,
  ...
  const [contactPersonIdProofFormData, setContactPersonIdProofFormData] = useState({
    url: undefined,
    formData: undefined,
    previewUrl: undefined,
  });
  ...
  useEffect(() => {
    if (props.state !== null) {
      props.state.authorizedPersonName && setAuthorizedPersonName(props.state.authorizedPersonName);
      props.state.authorizedPhoneNumber && setAuthorizedPhoneNumber(props.state.authorizedPhoneNumber);
      props.state.authorizedEmail && setAuthorizedEmail(props.state.authorizedEmail);
      props.state.authorizedPersonIdProofFormData?.url &&
        setAuthorizedPersonIdProofFormData(props.state.authorizedPersonIdProofFormData);
      props.state.contactPersonName && setContactPersonName(props.state.contactPersonName);
      props.state.contactPersonPhoneNumber &&
        setContactPersonPhoneNumber(props.state.contactPersonPhoneNumber);
      props.state.contactPersonEmail && setContactPersonEmail(props.state.contactPersonEmail);
      props.state.contactPersonIdProofFormData?.url &&
        setContactPersonIdProofFormData(props.state.contactPersonIdProofFormData);

      // setAuthorizedQatarId(props.state.authorizedQatarId);
      // setContactPersonQatarId(props.state.contactPersonQatarId);
    }
  }, [props.state]);
